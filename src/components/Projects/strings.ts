...
export const strings: Record<Language, Record<string, string | PortfolioProjectStrings>> = {
    en: {
        ...
        movye: {
            description:
                'Web app where you can search for a movie and see its information, add it to your favorites or your watchlist. Made using Next.js.',
    ...
    es: {
        ...
        movye: {
            description:
                'Un proyecto creado con Next.js. Busca información de tu película preferida y agrégala a tus favoritos o a tu watchlist.',
